...
DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4-unicode_ci
...
CREATE TABLE `tb_user` (
    ...
    `sole_code` varchar(10) DEFAULT NULL COMMENT '''角色编号',
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='合作商表';
