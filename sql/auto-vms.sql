...
CREATE DATABASE IF NOT EXISTS `auto-vms`
...
CREATE TABLE `tb_channel` (
  ...
  `price` int DEFAULT '0' COMMENT '货道商品真实售价',
...
CREATE TABLE `tb_node` (
  ...
  `owner_id` int NOT NULL COMMENT '点位主Id',
  `owner_name` varchar(50) DEFAULT NULL COMMENT '点位主名称',
...
CREATE TABLE `tb_vending_machine` (
  ...
  `vm_status` int NOT NULL DEFAULT '0' COMMENT '售货机状态，0:未投放;1-运营;3-撤机',
  `last_supply_time` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '上次补货时间',
  `city_code` varchar(10) NOT NULL DEFAULT '10' COMMENT '所在城市ID',
  ...
  `owner_id` int NOT NULL COMMENT '点位主Id',
  `owner_name` varchar(100) DEFAULT NULL COMMENT '所属合作商名称',
...
CREATE TABLE `tb_vendout_running` (
  ...
  `sku_id` bigint DEFAULT '0' COMMENT '商品编号',
...
CREATE TABLE `tb_vm_cfg_version` (
  ...
  `basecfg_version` bigint NOT NULL DEFAULT '1' COMMENT '基础配置版本',
  `sku_cfg_version` bigint NOT NULL DEFAULT '1' COMMENT '商品配置版本',
  `price_cfg_version` bigint NOT NULL DEFAULT '1' COMMENT '价格配置版本',
  `supply_version` bigint NOT NULL DEFAULT '0' COMMENT '补货版本',
